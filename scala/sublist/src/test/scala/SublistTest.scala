...
class SublistSpecs extends FunSuite with Matchers {
  ...
  test("empty is a sublist of anything") {
    Sublist.sublist(List(), List('a', 's', 'd', 'f')) should be(
      Sublist.Sublist)
  }

  test("anything is a superlist of empty") {
    Sublist.sublist(List('a', 's', 'd', 'f'), List()) should be(
      Sublist.Superlist)
  }
  ...
  test("sublist at start") {
    Sublist.sublist(List(1, 2, 3), List(1, 2, 3, 4, 5)) should be(
      Sublist.Sublist)
  }

  test("sublist in middle") {
    Sublist.sublist(List(4, 3, 2), List(5, 4, 3, 2, 1)) should be(
      Sublist.Sublist)
  }

  test("sublist at end") {
    Sublist.sublist(List(3, 4, 5), List(1, 2, 3, 4, 5)) should be(
      Sublist.Sublist)
  }
  ...
  test("superlist at start") {
    Sublist.sublist(List(1, 2, 3, 4, 5), List(1, 2, 3)) should be(
      Sublist.Superlist)
  }

  test("superlist in middle") {
    Sublist.sublist(List(5, 4, 3, 2, 1), List(4, 3, 2)) should be(
      Sublist.Superlist)
  }

  test("superlist at end") {
    Sublist.sublist(List(1, 2, 3, 4, 5), List(3, 4, 5)) should be(
      Sublist.Superlist)
  }

  test("partially matching superlist at start") {
    Sublist.sublist(List(1, 1, 1, 2), List(1, 1, 2)) should be(
      Sublist.Superlist)
  }
  ...
  test("recurring values sublist") {
    Sublist.sublist(List(1, 2, 1, 2, 3), List(1, 2, 3, 1, 2, 1, 2, 3, 2, 1)) should be(
      Sublist.Sublist)
  }

  test("recurring values unequal") {
    Sublist.sublist(List(1, 2, 1, 2, 3), List(1, 2, 3, 1, 2, 3, 2, 3, 2, 1)) should be(
      Sublist.Unequal)
  }
}
